...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.f($data.tabList, (page, index, i0) => {
      return {
        a: common_vendor.sr("page", "7a7e0f3e-0-" + i0, {
          "f": 1
        }),
        b: "7a7e0f3e-0-" + i0,
        c: common_vendor.p({
    ...
    g: $data.tabIndex,
    h: common_vendor.o((...args) => $options.onswiperchange && $options.onswiperchange(...args), "09"),
    i: common_vendor.o((...args) => $options.onswiperscroll && $options.onswiperscroll(...args), "bd"),
    j: common_vendor.o((...args) => $options.animationfinish && $options.animationfinish(...args), "79"),
    k: common_vendor.o((...args) => $options.animationfinish && $options.animationfinish(...args), "b3")
  };
}
