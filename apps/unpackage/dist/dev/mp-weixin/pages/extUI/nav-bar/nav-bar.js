...
const _sfc_main = {
  ...
  onPullDownRefresh() {
    common_vendor.index.__f__("log", "at pages/extUI/nav-bar/nav-bar.nvue:128", "onPullDownRefresh");
    setTimeout(function() {
      common_vendor.index.stopPullDownRefresh();
      common_vendor.index.__f__("log", "at pages/extUI/nav-bar/nav-bar.nvue:131", "stopPullDownRefresh");
    }, 1e3);
  }
};
if (!Array) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o($options.back, "67"),
    b: common_vendor.p({
      dark: true,
      fixed: true,
      shadow: true,
    ...
    f: common_vendor.o($options.back, "a9"),
    g: common_vendor.p({
      shadow: true,
      ["left-icon"]: "left",
      title: "开启阴影"
    ...
    i: common_vendor.o($options.back, "d6"),
    j: common_vendor.p({
      shadow: true,
      ["left-icon"]: "left",
      dark: true,
    ...
    x: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "38"),
    y: common_vendor.p({
      title: "自定义内容",
