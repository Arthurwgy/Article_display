...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.sr("collapse", "700c4ac7-2,700c4ac7-1"),
    g: common_vendor.o($options.change, "1a"),
    h: common_vendor.o(($event) => $data.value = $event, "85"),
    i: common_vendor.p({
    ...
    k: common_vendor.o((...args) => $options.add && $options.add(...args), "6d"),
    l: common_vendor.p({
      title: "使用动画",
      ["show-animation"]: true
    }),
    ...
    r: common_vendor.o($options.change, "60"),
    s: common_vendor.o(($event) => $data.accordionVal = $event, "02"),
    t: common_vendor.p({
      accordion: true,
    ...
    G: common_vendor.o($options.onClick, "d8"),
    H: common_vendor.p({
      title: "开启点击反馈",
      clickable: true,
      showArrow: true
