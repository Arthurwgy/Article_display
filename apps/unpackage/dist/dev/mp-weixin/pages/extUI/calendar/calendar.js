...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o($options.change, "83"),
    e: common_vendor.o($options.monthSwitch, "02"),
    f: common_vendor.p({
    ...
    h: common_vendor.o((...args) => $options.open && $options.open(...args), "1e"),
    i: common_vendor.sr("calendar", "15f97217-4"),
    j: common_vendor.o($options.confirm, "f4"),
    k: common_vendor.o($options.close, "42"),
    l: common_vendor.p({
      ["clear-date"]: true,
      date: $data.info.date,
