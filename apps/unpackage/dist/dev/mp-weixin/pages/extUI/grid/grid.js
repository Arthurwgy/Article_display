...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.f(4, (item, index, i0) => {
      return {
        a: "c36286d2-4-" + i0 + "," + ("c36286d2-3-" + i0),
        b: index,
        c: "c36286d2-3-" + i0 + ",c36286d2-2",
        d: common_vendor.p({
          index
        })
      };
    ...
    d: common_vendor.o($options.change, "c1"),
    e: common_vendor.p({
      column: 4,
      highlight: true
    }),
    ...
    g: common_vendor.f(8, (item, index, i0) => {
      return {
        a: "c36286d2-8-" + i0 + "," + ("c36286d2-7-" + i0),
        b: index,
        c: "c36286d2-7-" + i0 + ",c36286d2-6",
        d: common_vendor.p({
          index
        })
      };
    ...
    i: common_vendor.o($options.change, "01"),
    j: common_vendor.p({
      column: 4,
      highlight: true
    }),
    ...
    l: common_vendor.f($data.list, (item, index, i0) => {
      return {
        ...
        c: index,
        d: "c36286d2-11-" + i0 + ",c36286d2-10",
        e: common_vendor.p({
          index
        })
      };
    }),
    m: common_vendor.o($options.change, "01"),
    n: common_vendor.p({
      column: 3,
      highlight: true
    }),
    o: common_vendor.f($data.list, (item, index, i0) => {
      return {
        ...
        b: common_vendor.t(item.text),
        c: index,
        d: "c36286d2-13-" + i0 + ",c36286d2-12",
        e: common_vendor.p({
          index
        })
      };
    }),
    p: common_vendor.o($options.change, "05"),
    q: common_vendor.p({
      column: 3,
      highlight: true
    }),
    r: common_vendor.f($data.list, (item, index, i0) => {
      return {
        ...
        b: common_vendor.t(item.text),
        c: index,
        d: "c36286d2-15-" + i0 + ",c36286d2-14",
        e: common_vendor.p({
          index
        })
      };
    }),
    s: common_vendor.o($options.change, "72"),
    t: common_vendor.p({
      column: 3,
      highlight: true
    }),
    ...
    w: common_vendor.f($data.dynamicList, (item, index, i0) => {
      return {
        ...
        c: item.color,
        d: index,
        e: "c36286d2-18-" + i0 + ",c36286d2-17",
        f: common_vendor.p({
          index
        })
      };
    }),
    x: common_vendor.o($options.change, "da"),
    y: common_vendor.p({
      column: 3,
      highlight: true
    }),
    z: common_vendor.o((...args) => $options.add && $options.add(...args), "c8"),
    A: $data.dynamicList.length !== 0
  }, $data.dynamicList.length !== 0 ? {
    B: common_vendor.o((...args) => $options.del && $options.del(...args), "14")
  } : {}, {
    C: common_vendor.p({
      title: "动态加载",
      type: "line",
    ...
    D: common_vendor.f($data.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        d: "c36286d2-22-" + i0 + "," + ("c36286d2-21-" + i0),
        e: common_vendor.p({
          text: item.badge,
          type: item.type
        })
        ...
        f: index,
        g: "c36286d2-21-" + i0 + ",c36286d2-20",
        h: common_vendor.p({
          index
        })
      });
    }),
    E: common_vendor.o($options.change, "93"),
    F: common_vendor.p({
      column: 3,
      ["show-border"]: false,
      square: false
    ...
    H: common_vendor.f($data.list, (item, index, i0) => {
      return {
        ...
        b: common_vendor.t(item.text),
        c: index,
        d: "c36286d2-25-" + i0 + ",c36286d2-24",
        e: common_vendor.p({
          index
        })
      };
    }),
    I: common_vendor.o($options.change, "3d"),
    J: common_vendor.p({
      column: 3,
      square: false,
      highlight: false
    ...
    T: common_vendor.o($options.change, "6e"),
    U: common_vendor.p({
      column: 4,
      ["border-color"]: "#03a9f4"
    }),
