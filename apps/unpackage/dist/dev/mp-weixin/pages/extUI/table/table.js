  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "54f7ba45-7-" + i0 + "," + ("54f7ba45-6-" + i0),
        c: common_vendor.t(item.name),
        d: "54f7ba45-8-" + i0 + "," + ("54f7ba45-6-" + i0),
        e: common_vendor.t(item.address),
        f: "54f7ba45-9-" + i0 + "," + ("54f7ba45-6-" + i0),
        g: "54f7ba45-10-" + i0 + "," + ("54f7ba45-6-" + i0),
        h: index,
        i: "54f7ba45-6-" + i0 + ",54f7ba45-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "54f7ba45-0"),
    h: common_vendor.o($options.selectionChange, "43"),
    i: common_vendor.p({
    ...
    j: common_vendor.o($options.change, "91"),
    k: common_vendor.p({
      ["show-icon"]: true,
