...
const _sfc_main = {
  ...
  methods: {
    ...
    change(e) {
      common_vendor.index.__f__("log", "at pages/extUI/pagination/pagination.vue:55", e);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    h: common_vendor.o($options.change, "44"),
    i: common_vendor.p({
    ...
    m: common_vendor.o((...args) => $options.add && $options.add(...args), "9d"),
    n: common_vendor.o((...args) => $options.reset && $options.reset(...args), "ec"),
    o: common_vendor.p({
      title: "修改数据长度",
      type: "line",
      padding: true
