...
const _sfc_main = {
  ...
  methods: {
    onClick(e) {
      common_vendor.index.__f__("log", "at pages/extUI/list/list.nvue:125", "执行click事件", e.data);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    l: common_vendor.o($options.onClick, "82"),
    m: common_vendor.p({
      title: "弹窗提示",
      clickable: true
    }),
    n: common_vendor.o($options.onClick, "ec"),
    o: common_vendor.p({
      title: "页面跳转",
      to: `./chat`
    }),
    p: common_vendor.o($options.onClick, "b9"),
    q: common_vendor.p({
      title: "关闭当前页面打开新页面",
      showArrow: true,
      link: "redirectTo",
    ...
    r: common_vendor.o($options.onClick, "03"),
    s: common_vendor.p({
      title: "打开错误页面(查看控制台)",
      showArrow: true,
      link: "redirectTo",
