...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o($options.onClickItem, "ca"),
    c: common_vendor.p({
    ...
    j: common_vendor.o((...args) => $options.styleChange && $options.styleChange(...args), "54"),
    k: common_vendor.p({
      title: "Color",
      type: "line"
    }),
    ...
    m: common_vendor.o((...args) => $options.colorChange && $options.colorChange(...args), "b0")
  });
}
