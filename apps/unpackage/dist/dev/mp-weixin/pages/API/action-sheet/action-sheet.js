  ...
  methods: {
    actionSheetTap() {
      ...
      common_vendor.index.showActionSheet({
        ...
        success: (e) => {
          common_vendor.index.__f__("log", "at pages/API/action-sheet/action-sheet.vue:40", e.tapIndex);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o((...args) => $options.actionSheetTap && $options.actionSheetTap(...args), "c2")
  };
}
