...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.o((...args) => $options.getLocation && $options.getLocation(...args), "fe"),
    i: common_vendor.o((...args) => $options.clear && $options.clear(...args), "cb"),
    j: common_vendor.o((...args) => $options.openSetting && $options.openSetting(...args), "56"),
    k: common_vendor.o(($event) => $options.togglePopup(""), "59"),
    l: common_vendor.o(($event) => $options.togglePopup(""), "53"),
    m: common_vendor.p({
