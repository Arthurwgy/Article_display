  ...
  methods: {
    ...
    chooseImage: async function() {
      if (this.imageList.length === 9) {
        ...
        common_vendor.index.__f__("log", "at pages/API/image/image.vue:124", "是否继续?", isContinue);
        if (!isContinue) {
          return;
        }
      }
      common_vendor.index.chooseImage({
        ...
        fail: (err) => {
          common_vendor.index.__f__("log", "at pages/API/image/image.vue:137", "err: ", err);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: $data.sourceType,
    d: common_vendor.o((...args) => $options.sourceTypeChange && $options.sourceTypeChange(...args), "d7"),
    e: $data.sourceTypeIndex,
    f: common_vendor.t($data.sizeType[$data.sizeTypeIndex]),
    g: $data.sizeType,
    h: common_vendor.o((...args) => $options.sizeTypeChange && $options.sizeTypeChange(...args), "a8"),
    i: $data.sizeTypeIndex,
    j: common_vendor.t($data.count[$data.countIndex]),
    k: $data.count,
    l: common_vendor.o((...args) => $options.countChange && $options.countChange(...args), "d0"),
    ...
    o: common_vendor.o((...args) => $options.chooseImage && $options.chooseImage(...args), "6f")
  };
}
