...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: $data.res,
    c: common_vendor.o((...args) => $options.sendRequest && $options.sendRequest(...args), "57"),
    d: $data.loading,
    e: common_vendor.o(($event) => $options.sendRequest("promise"), "49"),
    f: $data.loading,
    g: common_vendor.o(($event) => $options.sendRequest("await"), "8e"),
    h: $data.loading
  };
}
