...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: $data.playTime,
    d: common_vendor.o((...args) => $options.seek && $options.seek(...args), "84"),
    e: $data.playing
  }, $data.playing ? {
    f: common_assets._imports_0$7,
    g: common_vendor.o((...args) => $options.stop && $options.stop(...args), "f6"),
    h: common_assets._imports_1,
    i: common_vendor.o((...args) => $options.pause && $options.pause(...args), "b1")
  } : {}, {
    j: !$data.playing
  }, !$data.playing ? {
    k: common_assets._imports_2$1,
    l: common_vendor.o((...args) => $options.play && $options.play(...args), "46")
  } : {});
}
