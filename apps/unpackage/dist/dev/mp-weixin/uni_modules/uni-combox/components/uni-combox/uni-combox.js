...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: $props.placeholder,
    e: common_vendor.o([($event) => $data.inputVal = $event.detail.value, (...args) => $options.onInput && $options.onInput(...args)], "76"),
    f: common_vendor.o((...args) => $options.onFocus && $options.onFocus(...args), "ab"),
    g: common_vendor.o((...args) => $options.onBlur && $options.onBlur(...args), "e9"),
    h: $data.inputVal,
    i: !$data.inputVal || !$props.clearAble
  }, !$data.inputVal || !$props.clearAble ? {
    j: common_vendor.o($options.toggleSelector, "f0"),
    k: common_vendor.p({
    ...
    m: common_vendor.o($options.clean, "ce"),
    n: common_vendor.p({
      type: "clear",
      size: "24",
      color: "#999"
