...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o((...args) => $options.touchStart && $options.touchStart(...args), "76"),
    e: common_vendor.o((...args) => $options.touchMove && $options.touchMove(...args), "12"),
    f: common_vendor.o((...args) => $options.touchEnd && $options.touchEnd(...args), "dc"),
    g: common_vendor.o((...args) => $options.mousedown && $options.mousedown(...args), "43"),
    h: common_vendor.o((...args) => $options.mousemove && $options.mousemove(...args), "23"),
    i: common_vendor.o((...args) => $options.mouseleave && $options.mouseleave(...args), "37"),
    j: $data.touchmove
  }, $data.touchmove ? {
