...
function initRuntimeSocketService() {
  const hosts = "192.168.1.11,192.168.56.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_aExRIo";
    ...
    }
    {
      ...
      if (!index$1.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index$1.__stat_uniCloud_space = _r.init(spaceData);
        } else {
...
exports.mapGetters = mapGetters$1;
